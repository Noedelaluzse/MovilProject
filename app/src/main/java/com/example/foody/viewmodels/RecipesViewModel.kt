...
import com.example.foody.util.Constants.Companion.DEFAULT_NUMBER
import com.example.foody.util.Constants.Companion.QUERY_ADD_RECIPE_INFORMATION
import com.example.foody.util.Constants.Companion.QUERY_APY_KEY_
...
class RecipesViewModel @Inject constructor(
    ...
    fun saveMealAndDietTyoe(mealType: String, mealTypeId: Int, dietType: String, dietTypeId: Int) =
    ...
    fun applyQueries(): HashMap<String, String> {
        ...
        queries[QUERY_APY_KEY_] = API_KEY
